export const InboxIcon = ({ className, width = '2.7rem', height = '2.7rem', color }) => {
  return (
    <svg
      className={className}
      width={width}
...
export const MessageIcon = ({ className, width = '3.2rem', height = '3.2rem', color }) => {
  return (
    <svg
      className={className}
      width={width}
...
export const UploadIcon = ({ className, width = '2rem', height = '2rem', color }) => {
  return (
    <svg
    className={className}
    width={width}
